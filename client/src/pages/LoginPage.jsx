  ...
  return (
    <div className="m-auto flex h-fit flex-col items-center justify-center gap-2 text-center">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          href={`https://accounts.google.com/o/oauth2/v2/auth?client_id=274353463964-kdkm3np5jbg5ts4l7vdksqj92m4or87q.apps.googleusercontent.com&redirect_uri=${API_URL}googleAuth/callback&response_type=code&scope=email profile`}
        >
        ...
        <a
          href={`https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=vlUKteyrG18vRROD6kqr&redirect_uri=${API_URL}naverAuth/callback&state=RANDOM_STATE`}
        >
